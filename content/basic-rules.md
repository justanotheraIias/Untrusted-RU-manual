...
В Untrusted, две основные [фракции](/Untrusted-RU-manual/factions) противостоят друг другу,
...
Игроки из [NETSEC](/Untrusted-RU-manual/factions/#NETSEC) могут выиграть путём взлома определённого компьютера (узла) в сети (также называемого целевым узлом)
или путём устранения всех членов AGENT.

Игроки из [AGENT](/Untrusted-RU-manual/factions/#AGENT) могут выиграть, убрав из игры всех членов NETSEC,
